...
{   
	...
	public void onCreate(Bundle savedInstanceState) 
	{
		...
		Button btn1_show = (Button) findViewById(R.id.show_popup1); 
		...
		{      
			...
			{	
				//Open popup window        
				if (button1p != null)        
					showPopup(TestPopupActivity.this, button1p);				
			}			
		}); 
		
		Button btn2_show = (Button) findViewById(R.id.show_popup2); 
		...
		{      
			...
			{	
				//Open popup window        
				if (button2p != null)        
					showPopup(TestPopupActivity.this, button2p);				
			}			
		});
	}
	...
	{      
		...
		Button button1 = (Button) findViewById(R.id.show_popup1);      
		...
		Button button2 = (Button) findViewById(R.id.show_popup2);      
